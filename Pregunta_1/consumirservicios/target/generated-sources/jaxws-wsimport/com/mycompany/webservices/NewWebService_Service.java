 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://webservices.mycompany.com/", wsdlLocation = "http://localhost:8080/WebServices/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://webservices.mycompany.com/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://webservices.mycompany.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.mycompany.com/", "NewWebServicePort"), NewWebService.class, features);
    }
